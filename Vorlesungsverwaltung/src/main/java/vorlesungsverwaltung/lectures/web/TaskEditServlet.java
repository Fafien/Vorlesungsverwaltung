...
//        request.setAttribute("categories", this.coursebean.findAllSorted());
//
//        Lecture lecture = this.getRequestedTask(request);
...
//
//        String lectureCourse = request.getParameter("task_category");
//        String lectureDueDate = request.getParameter("task_due_date");
//        String lectureDueTime = request.getParameter("task_due_time");
//        String lectureShortText = request.getParameter("task_short_text");
//
//        Lecture lecture = this.getRequestedTask(request);
//
...
//
//        if (dueDate != null) {
//            lecture.setDueDate(dueDate);
//        } else {
//            errors.add("Das Datum muss dem Format dd.mm.yyyy entsprechen.");
//        }
//
//        if (dueTime != null) {
//            lecture.setDueTime(dueTime);
//        } else {
//            errors.add("Die Uhrzeit muss dem Format hh:mm:ss entsprechen.");
//        }
//
//        lecture.setLectureName(lectureShortText);
//        
...
//     */
//    private Lecture getRequestedTask(HttpServletRequest request) {
//        // Zunächst davon ausgehen, dass ein neuer Satz angelegt werden soll
//        Lecture lecture = new Lecture();
//        lecture.setDueDate(new Date(System.currentTimeMillis()));
//        lecture.setDueTime(new Time(System.currentTimeMillis()));
//
...
//            WebUtils.formatDate(lecture.getDueDate())
//        });
//
